...
const Untitled6 = () => {
  return <SafeAreaView style={styles.safeArea}>
      ...
      position: 'relative',
      flex: 1
    }}><View style={styles.PVcKmVJn}></View><Text style={styles.hfYTCRdu}>Lorem ipsum…</Text><ImageBackground style={styles.WxDrbpSi} source={{
    ...
    <Text style={styles.iVKLKbWH}>Lorem ipsum…</Text></SafeAreaView>;
};
